...
public class EthereumChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new EthereumCharts().execute(); //hacemos execute
    }




    private class EthereumCharts extends AsyncTask<View, Void, ArrayList<DataEntry>> {

        @Override
        protected ArrayList<DataEntry> doInBackground(View... urls) {
            ArrayList<DataEntry> temp;
            //print the call in the console
            System.out.println("https://api.coingecko.com/api/v3/coins/ethereum/market_chart?vs_currency=USD&days=60&interval=daily");

            // make Call to the url

            temp = makeCall("https://api.coingecko.com/api/v3/coins/ethereum/market_chart?vs_currency=USD&days=60&interval=daily");
        ...
        protected void onPostExecute(ArrayList<DataEntry> prices) {
            ...
            cartesian.title("Value for Ethereum");

            cartesian.yAxis(0).title("Ethereum in USD");
