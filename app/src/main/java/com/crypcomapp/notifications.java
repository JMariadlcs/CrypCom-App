    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.ProfileButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(notifications.this).navigate(R.id.action_notifications_to_profile);
            }
        });
        view.findViewById(R.id.FavouritesButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(notifications.this).navigate(R.id.action_notifications_to_favourites);
            }
        });
